...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tags: ["Machine Design", "SolidWorks", "Power Transmission"],
      summary: "Designed a single-stage spur gear transmission system to meet performance requirements for top speed and hill climb events.",
      details: [
        "Selected gear parameters (module, number of teeth, gear ratio of 3.0) while ensuring interference and spacing constraints were satisfied.",
        "Developed detailed CAD models and technical drawings using SolidWorks.",
        "Performed force analysis and created free body diagrams for gears and shafts to validate design feasibility.",
        "Evaluated system performance through engineering calculations and iterative design refinement."
      ]
    },
    {
